...
const TableRow = (props) => {
    ...
    return <tr onClick={() => dispatch(changeCoin(props.ticker))}>
        ...
        <td className="colorized-cell hide-data"><PriceChange price={props.priceData ? props.priceData.percent_change_1h : null}/></td>
        <td className="colorized-cell"><PriceChange price={props.priceData ? props.priceData.percent_change_24h : null}/></td>
        <td className="colorized-cell hide-data"><PriceChange price={props.priceData ? props.priceData.percent_change_7d : null}/></td>
