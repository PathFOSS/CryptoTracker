    ...
    return <div id="chart-container">
        <ResponsiveContainer>
            <AreaChart width={500} height={400} data={priceData}>
                <YAxis type="number" width={props.priceData.price < 0.000001 || props.priceData.price >= 100000 ? 60 : 40} tick={{ fill: SecondaryWhite }} tickCount={10} interval={0} fontSize={"0.75rem"} orientation="left" domain={["auto", "auto"]} tickFormatter={FormatTick}/>
